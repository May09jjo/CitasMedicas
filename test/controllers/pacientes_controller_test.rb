...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { edad: @paciente.edad, fechaNac: @paciente.fechaNac, lastname: @paciente.lastname, name: @paciente.name, sexo: @paciente.sexo } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { edad: @paciente.edad, fechaNac: @paciente.fechaNac, lastname: @paciente.lastname, name: @paciente.name, sexo: @paciente.sexo } }
