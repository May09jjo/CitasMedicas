...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { doctor_id: @citum.doctor_id, fecha: @citum.fecha, paciente_id: @citum.paciente_id } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { doctor_id: @citum.doctor_id, fecha: @citum.fecha, paciente_id: @citum.paciente_id } }
